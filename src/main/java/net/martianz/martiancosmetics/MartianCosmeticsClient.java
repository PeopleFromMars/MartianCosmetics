...
@Mod(value = MartianCosmetics.MODID, dist = Dist.CLIENT)
@EventBusSubscriber(modid = MartianCosmetics.MODID, value = Dist.CLIENT)
public class MartianCosmeticsClient {

    public MartianCosmeticsClient(ModContainer container) {
